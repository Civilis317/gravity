...
public class AnimatedCircleOnCanvas extends Application {
    ...
    public void start(Stage stage) {
        ...
        //        Timeline timeline = new Timeline(new KeyFrame(Duration.seconds(0), new KeyValue(x, 0), new KeyValue(y, 0)), new KeyFrame(Duration.seconds(3), new KeyValue(x, W - D), new KeyValue(y, H - D)));
        ...
        AnimationTimer timer = new AnimationTimer() {
            ...
            public void handle(long now) {
                x.set(x.doubleValue() + 1);
                y.set(y.doubleValue() + 1);
